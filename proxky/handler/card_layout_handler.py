...
from proxky.configuration.variables import Ids, Paths, Distances
from proxky.handler.xml_handler import set_visibility, get_coordinates, set_coordinates, move, set_transparency
